            ...
            >
              <div className="w-full h-[380px] border rounded-xl overflow-hidden shadow-md hover:shadow-lg transition-shadow duration-300 bg-white">
                ...
                <div className="p-4">
                  ...
                  <div><span className="bg-green-700 text-white px-1 py-0.8 rounded font-semibold text-sm">
                      Getaway Deal
                    </span></div>
                  <div className="flex items-center gap-2 pt-[20px] ml-[70px]">
                    <p className="text-sm text-gray-500 "> 2 nights</p>
                    <p className="text-sm text-red-500 line-through">₹ {item.originalPrice.toLocaleString()}</p>
                    <p className="text-base font-semibold text-gray-800">₹ {item.discountedPrice.toLocaleString()}</p>
                  </div>
                </div>
              </div>
            </CarouselItem>
